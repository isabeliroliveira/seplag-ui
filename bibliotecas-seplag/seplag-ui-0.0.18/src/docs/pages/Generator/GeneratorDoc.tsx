...
const sections: DocSection[] = [
  // ── Parâmetros ───────────────────────────────────────────────────────────
  {
    title: "Parâmetros do comando",
    description: "Descrição de cada argumento aceito pelo gerador.",
    example: null as any,
    code: `Argumento         Obrigatório   Descrição
─────────────────────────────────────────────────────────────────────
...
--force / -f      Não           Sobrescreve arquivos já existentes.
                                Sem essa flag, arquivos existentes são pulados.`,
  },

  // ── Exemplos de uso ──────────────────────────────────────────────────────
  {
    title: "Exemplos de uso",
    description: "Casos comuns de invocação do gerador.",
    example: null as any,
    code: `# Mínimo — apenas o nome (endpoint e descrição derivados automaticamente)
...
npx seplag-generate TipoDocumento tipo-documento "Tipo de Documento" --force`,
  },
  ...
  // ── Arquivos gerados ─────────────────────────────────────────────────────
  {
    ...
    description:
      "Para o exemplo npx seplag-generate TipoDocumento tipo-documento \"Tipo de Documento\", os seguintes arquivos são criados:",
    example: null as any,
    code: `src/
├── config/
│   ├── permissions/
    ...
    └── Cadastro/
        └── TipoDocumento/
            ...
            └── components/
                ...
                └── ListTipoDocumentoTable.tsx`,
  },

  // ── Permissões geradas ───────────────────────────────────────────────────
  {
    title: "Arquivo de permissões gerado",
    description:
      "O gerador cria src/config/permissions/permissionTipoDocumento.ts com as constantes de permissão padronizadas.",
    example: null as any,
    code: `// src/config/permissions/permissionTipoDocumento.ts
...
export const DefaultPermissionsTipoDocumento: IDefaultPermissions = {
  ...
  // ── PageRoutes gerado ─────────────────────────────────────────────────────
  {
    title: "Arquivo de rotas gerado",
    description:
      "O gerador cria src/config/pageRoutes/pageRoutesTipoDocumento.ts com as 4 rotas padrão (listagem, cadastro, edição, visualização).",
    example: null as any,
    code: `// src/config/pageRoutes/pageRoutesTipoDocumento.ts
...
export const TipoDocumentoRoutes = [
  ...
  {
    title: "Atualizações automáticas em arquivos existentes",
    description:
      "O gerador tenta atualizar dois arquivos automaticamente. Sempre verifique o resultado após a geração.",
    example: null as any,
    code: `# ── 1. src/type/Enuns/LocalStorage_enum.ts ──────────────────────────────
...
# automaticamente — verifique sempre o arquivo após a geração.`,
  },

  // ── Mock mode ────────────────────────────────────────────────────────────
  {
    title: "Mock mode nos arquivos gerados",
    description:
      "Os arquivos gerados incluem um modo mock para desenvolvimento antes do backend estar disponível. Basta alterar a flag para false quando o endpoint estiver pronto.",
    example: null as any,
    code: `// ⚠️ ATENÇÃO: REMOVER — altere para false quando o endpoint estiver disponível.
...
// ⚠️ FIM DO MOCK`,
  ...
  // ── Passos manuais ───────────────────────────────────────────────────────
  {
    title: "Passos manuais após a geração",
    description:
      "O gerador entrega uma estrutura funcional com mock. Execute os passos abaixo para integrar com o backend real.",
    example: null as any,
    code: `1. VERIFIQUE o menu em src/config/menu.ts.
...
5. CONFIRA as permissões geradas em:
   ...
   Certifique-se de que os perfis no backend usam os mesmos códigos.`,
  },

  // ── Teste local ──────────────────────────────────────────────────────────
  {
    title: "Testando a lib localmente (antes da publicação no GitLab)",
    description:
      "Para usar a lib em outro projeto sem publicar no GitLab, use npm pack ou npm link.",
    example: null as any,
    code: `# ── Opção 1: npm pack (recomendado — simula o pacote real) ──────────────
# Na lib:
npm run pack:local
...
npm unlink @seplag/ui-lib-react-18`,
  },
];
...
export default function GeneratorDoc() {
  return (
    <DocPage
      title="seplag-generate"
      description="CLI gerador de CRUD completo — cria toda a estrutura de pages, features, types, rotas e permissões a partir de um único comando."
      badge="CLI"
      since="v0.0.1"
      importStatement={`# Instale a lib no projeto consumidor\nnpm install @seplag/ui-lib-react-18\n\n# Execute o gerador\nnpx seplag-generate <NomePascalCase> [endpoint] ["Descrição"] [--force]`}
      sections={sections}
    />
  );
}
