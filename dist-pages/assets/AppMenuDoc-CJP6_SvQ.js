import{t as e}from"./jsx-runtime-CUBmso4R.js";/* empty css              *//* empty css               */import{t}from"./AppMenu-DVTd9-82.js";import{t as n}from"./DocPage-D2k3n4h7.js";var r=e(),i=[{title:`Playground`,description:`Clique nos itens com seta para expandir os submenus.`,example:(0,r.jsx)(`div`,{className:`layout-sidebar layout-sidebar-dark`,style:{position:`relative`,width:250,minHeight:300,borderRadius:8},children:(0,r.jsx)(t,{items:[{label:`Início`,icon:`pi pi-home`,to:`#`,visibleOnMenu:!0,visibleOnRouter:!0},{label:`Cadastro`,icon:`pi pi-file-edit`,visibleOnMenu:!0,visibleOnRouter:!0,items:[{label:`Pessoas`,icon:`pi pi-users`,to:`#pessoas`,visibleOnMenu:!0,visibleOnRouter:!0},{label:`Empresas`,icon:`pi pi-building`,to:`#empresas`,visibleOnMenu:!0,visibleOnRouter:!0}]},{label:`Relatórios`,icon:`pi pi-chart-bar`,visibleOnMenu:!0,visibleOnRouter:!0,items:[{label:`Mensal`,icon:`pi pi-circle-on`,to:`#mensal`,visibleOnMenu:!0,visibleOnRouter:!0}]}],onMenuItemClick:e=>console.log(e)})}),code:`import { AppMenuSeplag } from "@seplag/ui-lib-react-18";
