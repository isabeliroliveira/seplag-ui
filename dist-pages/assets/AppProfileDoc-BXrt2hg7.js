import{t as e}from"./jsx-runtime-CUBmso4R.js";/* empty css              */import{t}from"./DocPage-CXwu6LQu.js";/* empty css               */import{t as n}from"./AppProfile-DGzdShtz.js";var r=e(),i=[{title:`Playground`,description:`Clique no nome do usuário para expandir as ações de perfil (alterar senha, trocar vínculo, sair).`,example:(0,r.jsx)(`div`,{style:{background:`#005494`,padding:`1.5rem`,borderRadius:8,display:`inline-block`,minWidth:220},children:(0,r.jsx)(n,{nomeApresentacao:`João da Silva`,numrVinculoAtual:`001`,vinculos:[{numrVinculo:`001`,statVinculo:`ATIVO`,unidade:{descUnidade:`STI`},orgao:{descOrgao:`SEPLAG`}},{numrVinculo:`002`,statVinculo:`ATIVO`,unidade:{descUnidade:`Coordenadoria de Sistemas`},orgao:{descOrgao:`SEPLAG`}}],onLogout:()=>alert(`Logout acionado`),onAlterarSenha:(e,t,n)=>alert(`Alterar senha:\nAtual: ${e}\nNova: ${t}\nConfirma: ${n}`),onSelecionarVinculo:e=>alert(`Vínculo selecionado: ${e.numrVinculo}`)})}),code:`import { AppProfileSeplag } from "@seplag/ui-lib-react-18";
