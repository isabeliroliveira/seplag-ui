import{t as e}from"./jsx-runtime-CUBmso4R.js";/* empty css              */import{t}from"./DocPage-CXwu6LQu.js";import{t as n}from"./AppMenu-B9HNB461.js";/* empty css               */var r=e(),i=[{title:`Playground`,description:`O AppSubmenuItemSeplag é o componente interno que renderiza cada item do menu. Clique em 'Item com submenu' para ver a animação de abertura.`,example:(0,r.jsx)(`div`,{className:`layout-sidebar layout-sidebar-dark`,style:{position:`relative`,width:250,minHeight:200,borderRadius:8},children:(0,r.jsx)(n,{items:[{label:`Item simples`,icon:`pi pi-home`,to:`#`,visibleOnMenu:!0,visibleOnRouter:!0},{label:`Item com submenu`,icon:`pi pi-chart-bar`,visibleOnMenu:!0,visibleOnRouter:!0,items:[{label:`Sub-item 1`,icon:`pi pi-circle-on`,to:`#sub1`,visibleOnMenu:!0,visibleOnRouter:!0},{label:`Sub-item 2`,icon:`pi pi-circle-on`,to:`#sub2`,visibleOnMenu:!0,visibleOnRouter:!0}]}],onMenuItemClick:e=>console.log(e)})}),code:`// Componente de uso interno — normalmente não é instanciado diretamente.
