import{i as e,n as t,t as n}from"./jsx-runtime-CUBmso4R.js";/* empty css              */import{n as r,t as i}from"./DocPage-CXwu6LQu.js";import{t as a}from"./AppSwitcher-DiufpllJ.js";var o=e(t(),1),s=n(),c=[{id:`sgi`,label:`SGI`,url:`#`,icon:`pi pi-briefcase`},{id:`siagro`,label:`SIAGRO`,url:`#`,icon:`pi pi-chart-bar`},{id:`seplag`,label:`SEPLAG`,url:`#`,icon:`pi pi-building`}];function l(){let[e,t]=(0,o.useState)(`SGI`),[n,i]=(0,o.useState)(3),l=c.slice(0,n),u=`import { AppSwitcherSeplag } from "@seplag/ui-lib-react-18";
...
<AppSwitcherSeplag
  items={items}
  currentSystem="${e}"
/>`;return(0,s.jsxs)(`div`,{className:`botao-playground`,children:[(0,s.jsx)(`div`,{className:`botao-playground-preview`,style:{background:`#005494`,padding:`1rem 1.5rem`,borderRadius:8},children:(0,s.jsx)(a,{items:l,currentSystem:e})}),(0,s.jsxs)(`div`,{className:`botao-playground-controls`,children:[(0,s.jsxs)(`div`,{className:`pg-field`,children:[(0,s.jsx)(`label`,{className:`pg-label`,htmlFor:`pg-current`,children:`currentSystem`}),(0,s.jsx)(`select`,{id:`pg-current`,className:`pg-select`,value:e,onChange:e=>t(e.target.value),children:c.map(e=>(0,s.jsx)(`option`,{value:e.label,children:e.label},e.id))})]}),(0,s.jsxs)(`div`,{className:`pg-field`,children:[(0,s.jsx)(`label`,{className:`pg-label`,htmlFor:`pg-numItems`,children:`número de sistemas`}),(0,s.jsxs)(`select`,{id:`pg-numItems`,className:`pg-select`,value:n,onChange:e=>i(Number(e.target.value)),children:[(0,s.jsx)(`option`,{value:1,children:`1`}),(0,s.jsx)(`option`,{value:2,children:`2`}),(0,s.jsx)(`option`,{value:3,children:`3`})]})]})]}),(0,s.jsx)(r,{code:u})]})}var u=[{title:`Playground`,description:`Experimente o AppSwitcher interativamente. O sistema selecionado como ativo fica destacado no painel.`,example:(0,s.jsx)(l,{}),code:``},{title:`Com ícones customizados (ReactNode)`,description:`O campo icon aceita tanto uma string de classe CSS (ex: PrimeIcons) quanto um ReactNode como componente.`,example:(0,s.jsx)(`div`,{style:{background:`#005494`,padding:`1rem 1.5rem`,borderRadius:8,display:`inline-flex`},children:(0,s.jsx)(a,{currentSystem:`SGI`,items:[{id:`s1`,label:`SGI`,url:`#`,icon:`pi pi-star`},{id:`s2`,label:`Portal`,url:`#`,icon:`pi pi-globe`}]})}),code:`import { AppSwitcherSeplag } from "@seplag/ui-lib-react-18";
