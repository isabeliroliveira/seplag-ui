import{i as e,n as t,t as n}from"./jsx-runtime-CUBmso4R.js";/* empty css              */import{t as r}from"./AppSwitcher-CdDSSG67.js";import{n as i,t as a}from"./DocPage-i5LU8ew4.js";var o=e(t(),1),s=n(),c=[{id:`sgi`,label:`SGI`,url:`#`,icon:`pi pi-briefcase`},{id:`siagro`,label:`SIAGRO`,url:`#`,icon:`pi pi-chart-bar`},{id:`seplag`,label:`SEPLAG`,url:`#`,icon:`pi pi-building`}];function l(){let[e,t]=(0,o.useState)(`SGI`),[n,a]=(0,o.useState)(3),l=c.slice(0,n),u=`import { AppSwitcherSeplag } from "@seplag/ui-lib-react-18";
