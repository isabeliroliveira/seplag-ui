import{t as e}from"./jsx-runtime-CUBmso4R.js";/* empty css              */import{t}from"./DocPage-CXwu6LQu.js";import{r as n}from"./checkbox.esm-B_wH-6qP.js";import{m as r}from"./Fields-B8sKRi-0.js";var i=e(),a=()=>null,o=[{label:`Mato Grosso`,value:`MT`},{label:`São Paulo`,value:`SP`},{label:`Rio de Janeiro`,value:`RJ`},{label:`Minas Gerais`,value:`MG`},{label:`Bahia`,value:`BA`}];function s(){let{control:e}=n({defaultValues:{uf:null,status:null}});return(0,i.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,i.jsx)(r,{name:`uf`,control:e,label:`UF`,options:o,optionLabel:`label`,optionValue:`value`,cols:`12 6`,getFormErrorMessage:a}),(0,i.jsx)(r,{name:`status`,control:e,label:`Status (obrigatório)`,options:[{label:`Ativo`,value:`A`},{label:`Inativo`,value:`I`}],optionLabel:`label`,optionValue:`value`,cols:`12 6`,required:!0,getFormErrorMessage:a})]})}var c=[{title:`Uso básico`,description:`Dropdown com filtro embutido e botão de limpar, integrado com react-hook-form.`,example:(0,i.jsx)(s,{}),code:`import { useForm } from "react-hook-form";
