import{t as e}from"./jsx-runtime-CUBmso4R.js";/* empty css              */import{t}from"./DocPage-CXwu6LQu.js";import{r as n}from"./checkbox.esm-B_wH-6qP.js";import{p as r}from"./Fields-B8sKRi-0.js";var i=e(),a=()=>null;function o(){let{control:e}=n({defaultValues:{email:``,emailInst:``}});return(0,i.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,i.jsx)(r,{name:`email`,control:e,label:`E-mail`,placeholder:`usuario@dominio.com`,cols:`12 6`,getFormErrorMessage:a}),(0,i.jsx)(r,{name:`emailInst`,control:e,label:`E-mail institucional (obrigatório)`,placeholder:`usuario@seplag.mt.gov.br`,cols:`12 6`,required:!0,getFormErrorMessage:a})]})}var s=[{title:`Uso básico`,description:`Campo de e-mail com validação de formato automática e remoção de espaços.`,example:(0,i.jsx)(o,{}),code:`import { useForm } from "react-hook-form";
