import{t as e}from"./jsx-runtime-CUBmso4R.js";/* empty css              */import{t}from"./DocPage-i5LU8ew4.js";var n=e(),r=[{title:`ResultsSeplag<T>`,description:"Interface genérica usada para respostas paginadas da API. Contém metadados de paginação e o array `content`.",example:null,code:`export interface ResultsSeplag<T> {
  content: T[];
