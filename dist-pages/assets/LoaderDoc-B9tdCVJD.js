...
dispatch(hideLoader()); // contador: 0 — overlay removido`}],p=[{name:`text`,type:`string`,required:!1,description:`Mensagem exibida abaixo da animação. Padrão: Carregando.`}];function m(){return(0,c.jsx)(i,{title:`LoaderSeplag`,description:`Overlay de carregamento que cobre toda a tela enquanto há operações pendentes. Controlado via Redux com contador de requisições — suporta chamadas paralelas sem piscar.`,badge:`Estável`,since:`v0.0.1`,importStatement:`import { LoaderSeplag } from "@seplag/ui-lib-react-18";
