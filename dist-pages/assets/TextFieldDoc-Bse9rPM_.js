import{t as e}from"./jsx-runtime-CUBmso4R.js";/* empty css              */import{t}from"./DocPage-CXwu6LQu.js";import{r as n}from"./checkbox.esm-B_wH-6qP.js";import{g as r}from"./Fields-B8sKRi-0.js";var i=e(),a=()=>null;function o(){let{control:e}=n({defaultValues:{nome:``,codigo:``}});return(0,i.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,i.jsx)(r,{name:`nome`,control:e,label:`Nome`,placeholder:`Digite o nome`,cols:`12 6`,getFormErrorMessage:a}),(0,i.jsx)(r,{name:`codigo`,control:e,label:`Código (somente letras/números)`,placeholder:`Ex: ABC123`,cols:`12 6`,allowNumberLetter:!0,getFormErrorMessage:a})]})}function s(){let{control:e}=n({defaultValues:{nomeObrigatorio:``,campoDesabilitado:``}});return(0,i.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,i.jsx)(r,{name:`nomeObrigatorio`,control:e,label:`Nome (obrigatório)`,placeholder:`Obrigatório`,cols:`12 6`,required:!0,getFormErrorMessage:a}),(0,i.jsx)(r,{name:`campoDesabilitado`,control:e,label:`Desabilitado`,placeholder:`Campo desabilitado`,cols:`12 6`,disabled:!0,getFormErrorMessage:a})]})}var c=[{title:`Uso básico`,description:`Campo de texto simples integrado com react-hook-form e Rótulo SEPLAG.`,example:(0,i.jsx)(o,{}),code:`import { useForm } from "react-hook-form";
