...
isDateBeforeSeplag("2024-12-31", "2024-01-01");  // false`,
  },
  {
    ...
    description:
      "Retorna true se a primeira data for posterior à segunda, ignorando horas.",
    example: null as any,
...
isDateAfterSeplag("01/01/2024", "31/12/2024");  // false`,
  ...
  // ── CPF / CNPJ ───────────────────────────────────────────────────────────
  {
    ...
    description:
      "Formata uma string de 11 dígitos (ou já mascarada) no padrão 999.999.999-99.",
    example: null as any,
...
formatCPFSeplag("");               // ""`,
  },
  {
    ...
    description:
      "Formata uma string de 14 dígitos no padrão 99.999.999/9999-99.",
    example: null as any,
...
formatCNPJSeplag("12345678000199");  // "12.345.678/0001-99"`,
  },
  {
    ...
    description:
      "Formata um CNPJ preenchendo zeros à esquerda para completar 14 dígitos. Retorna mensagem de erro se houver mais de 14 dígitos.",
    example: null as any,
...
formatarParaCNPJComPaddingSeplag("123456780001991");   // "CNPJ inválido (mais de 14 dígitos)"`,
  },
  {
    ...
    description:
      "Remove todos os caracteres não numéricos de uma string. Útil para enviar CPF/CNPJ ao backend.",
    example: null as any,
...
unmaskedSeplag("12.345.678/0001-99"); // "12345678000199"`,
  },
  {
    ...
    description:
      "Valida os dígitos verificadores de um CNPJ (aceita com ou sem máscara). Retorna false para sequências repetidas (ex: 00000000000000).",
    example: null as any,
...
const props: DocProp[] = [
  ...
  },
  {
    ...
    required: false,
    description:
      "Primeira data válida formatada. Retorna '-' se todas forem inválidas.",
  },
  {
    ...
    required: false,
    description:
      "Formata qualquer representação de data. Retorna undefined se inválida.",
  },
  {
    ...
    required: false,
    description:
      "Verdadeiro se date for anterior a dateToCompare (ignora horas).",
  },
  {
    ...
    required: false,
    description:
      "Verdadeiro se date for posterior a dateToCompare (ignora horas).",
  },
  // CPF/CNPJ
  {
  ...
  },
  {
    ...
    type: "(string) → string",
    required: false,
    description: "Remove todos os caracteres não numéricos.",
  },
  {
  ...
  // Grid
  {
    ...
    required: false,
    description:
      "Converte cols '12 6 4' em classes PrimeFlex col-12 md:col-6 lg:col-4.",
  },
];
